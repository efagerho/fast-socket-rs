//! Shared system-level vocabulary.
...
/// Queue identifier within a port, interface, or device.
#[derive(Clone, Copy, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
#[repr(transparent)]
...
/// Hugepage size preference for memory allocators.
#[derive(Clone, Copy, Debug, Default, Eq, PartialEq)]
#[non_exhaustive]
pub enum HugePageSize {
    /// Use the allocator or operating-system default hugepage size.
    ///
    /// Use [`Self::Size4K`] for the explicit no-hugepage path.
    #[default]
    Default,
